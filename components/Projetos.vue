<template>
  <div>
    ...
    <div class='main-four'>
        <h5><nuxt-link to="/projetos/ativos"><i class="fa-solid fa-bars-progress"></i> Projetos Ativos</nuxt-link></h5>
        <h5><nuxt-link to="/projetos/em-desenvolvimento"><i class="fa-solid fa-layer-group"></i> Projetos Em desenvolvimento</nuxt-link></h5>
    </div>
